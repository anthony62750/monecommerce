...
if($_POST){
    ...
    if(!$verif_caractere || strlen($_POST['pseudo'])<1 || strlen($_POST['pseudo'])>20) {
        $contenu .= "<div class='erreur'>Le pseudo doit contenir entre 1 et 20 caracteres. <br> Caractere acceptés : lettre de a à z et chiffres de 1 à 9</div>";
    }else {
...
<?php echo $contenu ?>
 <form method="post" action="">
    ...
    <input type="text" id="pseudo" name="pseudo" placeholder="Votre pseudo" title="caractères acceptés : a-zA-Z0-9-_.">
